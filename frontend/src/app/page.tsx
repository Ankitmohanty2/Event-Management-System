...
export default function Home() {
  return (
    <div className="relative min-h-[70vh] flex flex-col items-center justify-center text-center gap-6 overflow-hidden">
      <img src="/newback.jpg" alt="Background" className="absolute inset-0 w-full h-full object-cover -z-20 opacity-20" />
      <DottedSurface />
      <div className="relative z-10">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <a className="px-4 py-2 rounded-md border" href="/admin/events">Admin Dashboard</a>
        </div>
      </div>
    </div>
  );
